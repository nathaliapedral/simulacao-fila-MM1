...
for x in xrange(1,10):
	first_customer = Customer(0)
	customers_list.append(first_customer)
	first_arrival = Event('QS', 0.1*x, x)
	events_list.append(first_arrival)	

while statistics.sample_index < 62:
	...
	elif (current_event.event_type == "QS"):		
		current_event.queue_starter(customers_list, events_list, wait_queue)
